...
extern "C" MYFUNCTIONS_API void startScanBuf(const char* ipAddress, const char* port, const char* appId, const char* finger_, const char* returnId, const bool isLog, char* outBuffer, int bufferlen );
extern "C" MYFUNCTIONS_API void startScanAndGetFingerIDsBuf(const char* ipAddress, const char* port, const char* appId, const bool isLog, const char* authToken, char* outBuffer, int bufferLen);
extern "C" MYFUNCTIONS_API void startScanAndRegisterFingerIDsBuf(const char* ipAddress, const char* port, const char* appId, const char* finger, const char* returnId, const char* minutiae, const bool isLog, const char* authToken, char* outBuffer, int bufferLen);
